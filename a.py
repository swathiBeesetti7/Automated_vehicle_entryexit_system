...
def save_to_excel(excel_file, predictions):
    ...
    for class_name, confidence_score in predictions:
...
def predict():
    if request.method == 'POST':
        ...
        save_to_excel(filename, predictions)
        ...
        return render_template("video.html", predictions=predictions, img_path=vd_path)
